...
# Generated on: Mon May 25 02:08:43 +06 2026 (Sun May 24 20:08:43 UTC 2026)
...
set logfile fv/gpu/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/gpu -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/home/cadence/lnx/genus_21/tools.lnx86"
set CDN_SYNTH_ROOT      "/home/cadence/lnx/genus_21/tools.lnx86"
set env(CW_DIR) "/home/cadence/lnx/genus_21/tools.lnx86/lib/chipware"
set CW_DIR      "/home/cadence/lnx/genus_21/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /home/cadence/lnx/genus_21/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/home/cadence/lnx/genus_21/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/home/cadence/lnx/genus_21/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/home/cadence/lnx/genus_21/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/home/cadence/lnx/genus_21/tools.lnx86/lib/chipware/sim"
}
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k ../src/alu.v ../src/controller.v ../src/core.v ../src/dcr.v ../src/decoder.v ../src/dispatch.v ../src/fetcher.v ../src/gpu.v ../src/lsu.v ../src/pc.v ../src/registers.v ../src/scheduler.v
elaborate_design -golden -root {gpu} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/gpu/fv_map.v.gz
elaborate_design -revised -root {gpu}
...
#add_name_alias fv/gpu/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.gpu.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.gpu.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.gpu.rtl.fv_map.rpt
